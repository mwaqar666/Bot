...
from framework.data.data_types import SignalDirection, PositionSide, SimulatedTrade
...
class TradingEnvironment(gym.Env):
    ...
    def step(self, action: SignalDirection) -> tuple[np.ndarray, float, bool, bool, dict]:
        ...
        info = {
            ...
            "trade_pnl": trade.pnl_pct if trade else 0.0,
            "entry_price": trade.entry_price if trade else 0.0,
            "exit_price": trade.exit_price if trade else 0.0,
            "sl_price": trade.sl_price if trade else 0.0,
            "tp_price": trade.tp_price if trade else 0.0,
        }
